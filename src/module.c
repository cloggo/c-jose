...
napi_value Init(napi_env env, napi_value exports) {
  ...
  napi_property_descriptor descArray[] = {
    ...
    DECLARE_NAPI_METHOD("jose_json_deep_copy", c_jose_json_deep_copy),
    ...
    DECLARE_NAPI_METHOD("jose_json_array", c_jose_json_array),
    ...
    DECLARE_NAPI_METHOD("jose_json_array_append_new", c_jose_json_array_append_new),
    DECLARE_NAPI_METHOD("jose_json_array_append", c_jose_json_array_append),
    DECLARE_NAPI_METHOD("jose_json_array_insert", c_jose_json_array_insert),
    DECLARE_NAPI_METHOD("jose_json_array_insert_new", c_jose_json_array_insert_new),
    DECLARE_NAPI_METHOD("jose_json_array_extend", c_jose_json_array_extend),
    DECLARE_NAPI_METHOD("jose_json_array_remove", c_jose_json_array_remove),
    DECLARE_NAPI_METHOD("jose_json_array_clear", c_jose_json_array_clear),
    ...
    DECLARE_NAPI_METHOD("jose_json_object", c_jose_json_object),
    DECLARE_NAPI_METHOD("jose_json_object_update", c_jose_json_object_update),
    DECLARE_NAPI_METHOD("jose_json_object_set", c_jose_json_object_set),
    DECLARE_NAPI_METHOD("jose_json_object_set_new", c_jose_json_object_set_new),
    DECLARE_NAPI_METHOD("jose_json_object_del", c_jose_json_object_del),
    DECLARE_NAPI_METHOD("jose_json_object_clear", c_jose_json_object_clear),
    DECLARE_NAPI_METHOD("jose_json_create", c_jose_json_create),
